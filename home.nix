...

{
  ...
  home.file.".config/hypr/hyprland.conf" = {
    text = ''
  # MONITOR
  monitor=DP-1,3840x2160@165,0x0,2,bitdepth,10,vrr,2,cm,hdr,sdrbrightness,1.5,sdrsaturation,1.5
  render {
    direct_scanout = 2
  }
  ...
  bind = $mainMod CTRL, X, exec, hyprctl kill
  bind = $mainMod SHIFT, F, exec, filelight
